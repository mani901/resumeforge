...
-- AddForeignKey
ALTER TABLE "JobApplication" ADD CONSTRAINT "JobApplication_snapshotId_fkey" FOREIGN KEY ("snapshotId") REFERENCES "ResumeSnapshot"("id") ON DELETE SET NULL ON UPDATE CASCADE;
